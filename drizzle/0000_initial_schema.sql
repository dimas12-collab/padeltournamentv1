...
CREATE TYPE "public"."user_role" AS ENUM('SUPER_ADMIN', 'EVENT_ADMIN', 'SCOREKEEPER');--> statement-breakpoint
CREATE TYPE "public"."match_stage" AS ENUM('GROUP', 'QUARTER_FINAL', 'SEMI_FINAL', 'FINAL', 'OTHER');--> statement-breakpoint
...
CREATE TABLE "categories" (
	...
	"name" text NOT NULL,
	"slug" text NOT NULL,
	"scoring_rule" jsonb DEFAULT '{}'::jsonb NOT NULL,
	"tie_break_rule" jsonb DEFAULT '[]'::jsonb NOT NULL,
...
CREATE TABLE "users" (
	...
	"image" text,
	"role" "user_role" DEFAULT 'SCOREKEEPER' NOT NULL,
...
ALTER TABLE "courts" ADD CONSTRAINT "courts_event_id_events_id_fk" FOREIGN KEY ("event_id") REFERENCES "public"."events"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "groups" ADD CONSTRAINT "groups_category_id_categories_id_fk" FOREIGN KEY ("category_id") REFERENCES "public"."categories"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "categories_event_slug_unique" ON "categories" USING btree ("event_id","slug");--> statement-breakpoint
CREATE UNIQUE INDEX "events_slug_unique" ON "events" USING btree ("slug");--> statement-breakpoint
CREATE UNIQUE INDEX "match_sets_match_number_unique" ON "match_sets" USING btree ("match_id","set_number");--> statement-breakpoint
CREATE INDEX "matches_event_schedule_idx" ON "matches" USING btree ("event_id","scheduled_at");--> statement-breakpoint
CREATE INDEX "matches_group_status_idx" ON "matches" USING btree ("group_id","status");--> statement-breakpoint
